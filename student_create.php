					...
					<div class="x_content">
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<input type="text" id="fname" name="fatherName" class="form-control ">
									</div>
									<div class="col-sm-6">
										<label for="mname">Mother's Name </label>
										<input type="text" id="mname" name="motherName" class="form-control ">
									</div>
								</div>
							</div>
							<div class="form-group">
						...
						<?php
							if($_POST){
							  ...
							  $result=$mysqli->common_create('students',$_POST);
							  if($result['error']){
								$_SESSION['class']="danger";
								$_SESSION['msg']=$result['error'];
								echo "<script> location.replace('$base_url/student_create.php')</script>";
							  }else{
